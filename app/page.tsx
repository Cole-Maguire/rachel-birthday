...
export default function Home() {
  ...
  useEffect(() => {
    logoPopoverRef.current?.showPopover();
    setIsFirstRender(true);
    setTimeout(() => {
      if (logoPopoverRef.current) {
        logoPopoverRef.current.classList.add("slide-off");
      }
    }, 3000);
  ...
  return (
    <div className="flex grid h-dvh min-h-dvh grid-flow-row gap-6 overflow-hidden p-8 font-[family-name:var(--bumble-font)]">
      <div
        ...
        id="splash-screen"
        ref={logoPopoverRef}
        className="bg-(--bumble-yellow) h-full w-full"
      >
        <div className="flex h-full w-full items-center justify-center">
          <Image
            src="/rachel-birthday/bumble-logo-white.png"
            alt="bumble logo"
            width={200}
            height={50}
            priority
        ...
        <>
          ...
          >
            <div className="h-vh min-h-min w-full flex-1 flex-col items-center gap-8 rounded-lg font-medium transition-transform sm:items-start">
              ...
              <div className="p-4">
                ...
                I&apos;m just a boy looking for a very special girl on her
                birthday. Do you think you could help me?
                <div className="text-[var(--bumble-background-text)]">
                  My basics
          ...
          <footer className="flex flex-wrap items-center justify-evenly">
            <button
              ...
              onClick={swipeLeft}
            >
              <span className="material-icons text-6xl! select-none">
                close
              </span>
            </button>
            <button
